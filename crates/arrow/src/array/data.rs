...
pub(crate) fn new_buffers(data_type: &DataType, capacity: usize) -> [MutableBuffer; 2] {
    ...
    match data_type {
        ...
        DataType::Date32 | DataType::Time32(_) | DataType::Timestamp32(_) => [
            MutableBuffer::new(capacity * mem::size_of::<i32>()),
            empty_buffer,
        ],
        DataType::Date64
...
fn layout(data_type: &DataType) -> DataTypeLayout {
    ...
    match data_type {
        ...
        DataType::Date16 => DataTypeLayout::new_fixed_width(size_of::<u16>()),
        DataType::Timestamp32(_) => DataTypeLayout::new_fixed_width(size_of::<u32>()),
