    ...
    i64: std::convert::From<T::Native>,
{
    ...
    match array.data_type() {
        ...
        &DataType::Date32 | &DataType::Date64 | &DataType::Timestamp(_, None) | &DataType::Timestamp32(_) => {
    ...
    i64: std::convert::From<T::Native>,
{
    let mut b = Int32Builder::new(array.len());
    match array.data_type() {
        &DataType::Date32 | &DataType::Date64 | &DataType::Timestamp(_, _) | &DataType::Timestamp32(_) => {
    ...
    i64: std::convert::From<T::Native>,
{
    let mut b = Int32Builder::new(array.len());
    match array.data_type() {
        &DataType::Date64 | &DataType::Timestamp(_, None) | &DataType::Timestamp32(_) => {
