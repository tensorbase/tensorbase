...
impl BuiltinScalarFunction {
    ...
    pub fn volatility(&self) -> Volatility {
        match self {
            ...
            BuiltinScalarFunction::ClickHouseBuiltin(_) => Volatility::Immutable,
        }
    }
}
...
pub fn return_type(
    ...
    match fun {
        BuiltinScalarFunction::ClickHouseBuiltin(fun) => fun.return_type(input_expr_types),
...
pub fn create_physical_expr(
    ...
    let fun_expr: ScalarFunctionImplementation = match fun {
        ...
        BuiltinScalarFunction::ClickHouseBuiltin(fun) => fun.func_impl(input_phy_exprs, input_schema)?,
        BuiltinScalarFunction::ToTimestamp => {
